...
def main():
    ...
    # GP
    initGP(toolbox, X, y, num_features=2, limitDepth=10, limitSize=15, realData=False)
    ...
    stats_fit.register("lex avg", lexAvg)
    ...
    # RUN
    pop, logbook = algorithms.eaSimple(pop, toolbox, 0.7, 0.3, 50, stats=mstats,
